  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="active" href="{{URL:: to('/')}}">PROGRAMMER SOUTENANCE</a></li>
          <li><a href="#">GERER SESSION DE STAGE</a></li>
          ...
          <li><a href="#">GERER DATE LIMITE DES DEPOTS</a></li>
          
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav><!-- .navbar -->

      <a href="{{URL:: to('/')}}" class="get-started-btn">DECONNEXION</a>
